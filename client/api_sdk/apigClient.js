...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://7z1q6hpgd5.execute-api.us-east-1.amazonaws.com/testing';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customlabels', 'name'], ['body']);
